...
void LambertPhongNormalMapTests::update(ELFloat deltaTime) {
    ...
    lambertPhongRenderer->setNormalMap(normalTexture);
...
LambertPhongNormalMapTests::LambertPhongNormalMapTests(std::map<std::string, ELRenderPiplinePtr> piplines) {
